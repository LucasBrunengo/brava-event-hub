...
export const mockEvents: Event[] = [
  ...
  // Add more public events with various categories
  {
    id: 'pub1',
    name: 'Comedy Night at Jamboree',
    description: 'Stand-up comedy showcase featuring local and international comedians. A night full of laughs!',
    date: new Date(new Date().setDate(new Date().getDate() + 14)).toISOString().split('T')[0],
    time: '9:00 PM',
    location: 'Jamboree Jazz Club, Plaça Reial',
    organizerId: 'prod1',
    organizer: mockUsers.find(u => u.id === 'prod1')!,
    attendees: [],
  ...
  },
  {
    ...
    description: 'Authentic flamenco performance with traditional Spanish dinner. Experience the passion of flamenco!',
    date: new Date(new Date().setDate(new Date().getDate() + 18)).toISOString().split('T')[0],
    time: '8:00 PM',
    location: 'Tablao Cordobés, Las Ramblas',
    organizerId: 'prod2',
    organizer: mockUsers.find(u => u.id === 'prod2')!,
    attendees: [],
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    description: 'Join us for a relaxing yoga session as the sun sets over Barceloneta Beach. All levels welcome!',
  ...
  },
  {
    ...
    description: 'Guided tapas tour through the historic Gothic Quarter. Taste the best local cuisine!',
    date: new Date(new Date().setDate(new Date().getDate() + 10)).toISOString().split('T')[0],
    time: '6:00 PM',
    location: 'Gothic Quarter Meeting Point',
    organizerId: 'prod1',
    organizer: mockUsers.find(u => u.id === 'prod1')!,
    attendees: [],
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    description: 'Live jazz music under the stars on a beautiful Barcelona rooftop. Drinks and good vibes!',
    date: new Date(new Date().setDate(new Date().getDate() + 21)).toISOString().split('T')[0],
    time: '9:00 PM',
    location: 'Hotel Pullman Rooftop',
    organizerId: 'prod2',
    organizer: mockUsers.find(u => u.id === 'prod2')!,
    attendees: [],
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    description: 'Learn to cook authentic Mediterranean dishes with a professional chef. Includes lunch!',
    date: new Date(new Date().setDate(new Date().getDate() + 15)).toISOString().split('T')[0],
    time: '11:00 AM',
    location: 'Barcelona Cooking School, Eixample',
    organizerId: 'prod3',
    organizer: mockUsers.find(u => u.id === 'prod3')!,
    attendees: [],
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    description: 'Introduction to meditation and mindfulness practices. Find your inner peace.',
    date: new Date(new Date().setDate(new Date().getDate() + 12)).toISOString().split('T')[0],
    time: '10:00 AM',
    location: 'Zen Space Barcelona',
    organizerId: 'prod1',
    organizer: mockUsers.find(u => u.id === 'prod1')!,
    attendees: [],
    createdAt: new Date().toISOString(),
  ...
  {
    id: 'pub8',
    name: 'Silent Disco at Park Güell',
    description: 'Dance to your own beat at this unique silent disco in the iconic Park Güell!',
...
export const mockVenues: Venue[] = [
  ...
  { id: 'v5', name: 'Trattoria Roma', category: 'restaurant', address: 'Passeig de Gràcia, 12', hasReservations: true, cuisines: ['Italian', 'Pasta'], tags: ['romantic'], availability: [], promoted: false, distanceKm: 2.1, imageUrl: 'https://images.unsplash.com/photo-1551183053-bf91a1d81141?w=400&h=300&fit=crop' },
  { id: 'v6', name: 'El Asador', category: 'restaurant', address: 'Carrer de Valencia, 45', hasReservations: true, cuisines: ['Steakhouse', 'Grill'], tags: ['reservations'], availability: [], promoted: true, distanceKm: 3.0, imageUrl: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=400&h=300&fit=crop' },
  { id: 'v7', name: 'Green Bowl', category: 'restaurant', address: 'Carrer de Pelai, 9', hasReservations: true, cuisines: ['Healthy', 'Vegan'], tags: ['vegan-options'], availability: [], promoted: false, distanceKm: 0.9, imageUrl: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=300&fit=crop' },
  { id: 'v8', name: 'La Paella House', category: 'restaurant', address: 'Ronda de Sant Pere, 3', hasReservations: true, cuisines: ['Spanish', 'Paella'], tags: [], availability: [], promoted: false, distanceKm: 2.7, imageUrl: 'https://images.unsplash.com/photo-1534080564583-6be75777b70a?w=400&h=300&fit=crop' },
  { id: 'v9', name: 'Bao Republic', category: 'restaurant', address: 'Carrer de Tallers, 22', hasReservations: true, cuisines: ['Asian', 'Street Food'], tags: [], availability: [], promoted: true, distanceKm: 1.5, imageUrl: 'https://images.unsplash.com/photo-1496116218417-1a781b1c416c?w=400&h=300&fit=crop' },
  // Additional wellness
  { id: 'v10', name: 'DIR Functional Sagrada Família', category: 'wellness', address: 'Av. Gaudí, 30', hasReservations: true, tags: ['functional', 'classes', 'gym'], availability: [], promoted: true, distanceKm: 2.9, imageUrl: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&h=300&fit=crop' },
  { id: 'v11', name: 'Hot Yoga BCN', category: 'wellness', address: 'Carrer de Casp, 88', hasReservations: true, tags: ['yoga', 'hot-yoga'], availability: [], promoted: false, distanceKm: 1.1, imageUrl: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=400&h=300&fit=crop' },
  { id: 'v12', name: 'Urban Spa Retreat', category: 'wellness', address: 'Passeig de Sant Joan, 40', hasReservations: true, tags: ['spa', 'sauna'], availability: [], promoted: false, distanceKm: 3.4, imageUrl: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=400&h=300&fit=crop' },
  // Bars/Karaoke/Clubs (entertainment) - adding more variety
  { id: 'v13', name: 'Barkadia', category: 'entertainment', address: 'Born, 12', hasReservations: false, tags: ['bars'], availability: [], promoted: true, distanceKm: 1.8, imageUrl: 'https://images.unsplash.com/photo-1436076863939-06870fe779c2?w=400&h=300&fit=crop' },
  { id: 'v14', name: 'Sing It Karaoke', category: 'entertainment', address: 'Eixample, 77', hasReservations: true, tags: ['karaoke'], availability: [], promoted: false, distanceKm: 2.2, imageUrl: 'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=400&h=300&fit=crop' },
  { id: 'v15', name: 'Club Aurora', category: 'entertainment', address: 'Port Olímpic', hasReservations: false, tags: ['clubs'], availability: [], promoted: true, distanceKm: 3.9, imageUrl: 'https://images.unsplash.com/photo-1519677100203-a0e668c92439?w=400&h=300&fit=crop' },
  { id: 'v16', name: 'Taproom BCN', category: 'entertainment', address: 'Gràcia, 15', hasReservations: false, tags: ['bars'], availability: [], promoted: false, distanceKm: 2.6, imageUrl: 'https://images.unsplash.com/photo-1436076863939-06870fe779c2?w=400&h=300&fit=crop' },
  { id: 'v17', name: 'K-Town Karaoke', category: 'entertainment', address: 'Les Corts, 20', hasReservations: true, tags: ['karaoke'], availability: [], promoted: false, distanceKm: 4.1, imageUrl: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=400&h=300&fit=crop' },
  { id: 'v18', name: 'Velvet Night', category: 'entertainment', address: 'Diagonal, 300', hasReservations: false, tags: ['clubs'], availability: [], promoted: true, distanceKm: 2.0, imageUrl: 'https://images.unsplash.com/photo-1566737236500-c8ac43014a67?w=400&h=300&fit=crop' },
  { id: 'v19', name: 'Gastro Bar 58', category: 'entertainment', address: 'Poble Sec, 58', hasReservations: true, tags: ['bars'], availability: [], promoted: false, distanceKm: 1.3, imageUrl: 'https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=400&h=300&fit=crop' },
  { id: 'v20', name: "Chef's Table BCN", category: 'restaurant', address: 'El Raval, 5', hasReservations: true, cuisines: ['Fine Dining'], tags: [], availability: [], promoted: true, distanceKm: 2.8, imageUrl: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=300&fit=crop' },
  // More entertainment venues
  { id: 've30a', name: 'Opium Barcelona', category: 'entertainment', address: 'Port Olímpic, 1', hasReservations: true, tags: ['clubs'], availability: [], promoted: true, distanceKm: 3.5, imageUrl: 'https://images.unsplash.com/photo-1519677100203-a0e668c92439?w=400&h=300&fit=crop' },
  { id: 've31a', name: 'The Box Cocktails', category: 'entertainment', address: 'El Born, 23', hasReservations: false, tags: ['bars'], availability: [], promoted: false, distanceKm: 1.5, imageUrl: 'https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=400&h=300&fit=crop' },
  { id: 've32a', name: 'Razzmatazz', category: 'entertainment', address: 'Poblenou, 88', hasReservations: true, tags: ['clubs'], availability: [], promoted: true, distanceKm: 2.8, imageUrl: 'https://images.unsplash.com/photo-1516450137517-162bfbeb8dba?w=400&h=300&fit=crop' },
  { id: 've33a', name: 'Milano Cocktail Bar', category: 'entertainment', address: 'Eixample, 35', hasReservations: false, tags: ['bars'], availability: [], promoted: false, distanceKm: 1.2, imageUrl: 'https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=400&h=300&fit=crop' },
  { id: 've34a', name: 'Karaoke Kings', category: 'entertainment', address: 'Gràcia, 90', hasReservations: true, tags: ['karaoke'], availability: [], promoted: true, distanceKm: 2.4, imageUrl: 'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=400&h=300&fit=crop' },
  { id: 've35a', name: 'Shôko Beach Club', category: 'entertainment', address: 'Port Olímpic, 36', hasReservations: true, tags: ['clubs'], availability: [], promoted: true, distanceKm: 3.7, imageUrl: 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=400&h=300&fit=crop' },

  // Bulk additions for restaurants
{ id: 'vr21', name: 'Pizza Napo BCN', category: 'restaurant', address: 'Gràcia 101', hasReservations: true, cuisines: ['Italian','Pizza'], tags: ['family'], availability: [], promoted: false, distanceKm: 2.2, imageUrl:'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400&h=300&fit=crop' },
...
{ id: 'vr25', name: 'Pho Saigon', category: 'restaurant', address: 'Sants 12', hasReservations: true, cuisines: ['Vietnamese'], tags: [], availability: [], promoted: false, distanceKm: 4.4, imageUrl:'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=400&h=300&fit=crop' },
...
{ id: 'vr27', name: 'Kebab Istanbul', category: 'restaurant', address: 'Clot 3', hasReservations: true, cuisines: ['Middle Eastern'], tags: [], availability: [], promoted: false, distanceKm: 3.1, imageUrl:'https://images.unsplash.com/photo-1529006557810-274b9b2fc783?w=400&h=300&fit=crop' },
...
{ id: 'vr32', name: 'BBQ Smokehouse', category: 'restaurant', address: 'Poble Sec 45', hasReservations: true, cuisines: ['BBQ'], tags: [], availability: [], promoted: false, distanceKm: 3.8, imageUrl:'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=400&h=300&fit=crop' },
...
{ id: 'vr34', name: 'Noodle Bar', category: 'restaurant', address: 'Born 66', hasReservations: true, cuisines: ['Asian'], tags: [], availability: [], promoted: false, distanceKm: 2.9, imageUrl:'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=400&h=300&fit=crop' },
...
{ id: 've21', name: 'Bar Central', category: 'entertainment', address: 'Eixample 12', hasReservations: false, tags: ['bars'], availability: [], promoted: false, distanceKm: 1.1, imageUrl:'https://images.unsplash.com/photo-1436076863939-06870fe779c2?w=400&h=300&fit=crop' },
{ id: 've22', name: 'Karaoke Star', category: 'entertainment', address: 'Gràcia 44', hasReservations: true, tags: ['karaoke'], availability: [], promoted: true, distanceKm: 2.2, imageUrl:'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=400&h=300&fit=crop' },
...
{ id: 've24', name: 'Craft Beer Co', category: 'entertainment', address: 'Poble Sec 14', hasReservations: false, tags: ['bars'], availability: [], promoted: false, distanceKm: 2.5, imageUrl:'https://images.unsplash.com/photo-1436076863939-06870fe779c2?w=400&h=300&fit=crop' },
{ id: 've25', name: 'Sing Along BCN', category: 'entertainment', address: 'Sants 22', hasReservations: true, tags: ['karaoke'], availability: [], promoted: false, distanceKm: 3.6, imageUrl:'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=400&h=300&fit=crop' },
...
{ id: 've28', name: 'Retro Karaoke', category: 'entertainment', address: 'Eixample 199', hasReservations: true, tags: ['karaoke'], availability: [], promoted: true, distanceKm: 2.8, imageUrl:'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=400&h=300&fit=crop' },
...
{ id: 've30', name: 'Sky Bar', category: 'entertainment', address: 'Rooftop 1', hasReservations: false, tags: ['bars'], availability: [], promoted: false, distanceKm: 1.0, imageUrl:'https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=400&h=300&fit=crop' },
...
{ id: 've32', name: 'Taproom 2', category: 'entertainment', address: 'Sants 8', hasReservations: false, tags: ['bars'], availability: [], promoted: false, distanceKm: 2.9, imageUrl:'https://images.unsplash.com/photo-1436076863939-06870fe779c2?w=400&h=300&fit=crop' },
{ id: 've33', name: 'Karaoke Box', category: 'entertainment', address: 'Les Corts 19', hasReservations: true, tags: ['karaoke'], availability: [], promoted: false, distanceKm: 3.1, imageUrl:'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=400&h=300&fit=crop' },
...
{ id: 've35', name: 'Old Town Pub', category: 'entertainment', address: 'Gòtic 44', hasReservations: false, tags: ['bars'], availability: [], promoted: false, distanceKm: 0.6, imageUrl:'https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=400&h=300&fit=crop' }
];
