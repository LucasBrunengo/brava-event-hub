...
export const mockVenues: Venue[] = [
  ...
  { id: 've30', name: 'Opium Barcelona', category: 'entertainment', address: 'Port Olímpic, 1', hasReservations: true, tags: ['clubs'], availability: [], promoted: true, distanceKm: 3.5, imageUrl: 'https://images.unsplash.com/photo-1520483601560-4b1128ff2f91?w=400&h=300&fit=crop' },
  { id: 've31', name: 'The Box Cocktails', category: 'entertainment', address: 'El Born, 23', hasReservations: false, tags: ['bars'], availability: [], promoted: false, distanceKm: 1.5, imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c76f0?w=400&h=300&fit=crop' },
  { id: 've32', name: 'Razzmatazz', category: 'entertainment', address: 'Poblenou, 88', hasReservations: true, tags: ['clubs'], availability: [], promoted: true, distanceKm: 2.8, imageUrl: 'https://images.unsplash.com/photo-1516450137517-162bfbeb8dba?w=400&h=300&fit=crop' },
  { id: 've33', name: 'Milano Cocktail Bar', category: 'entertainment', address: 'Eixample, 35', hasReservations: false, tags: ['bars'], availability: [], promoted: false, distanceKm: 1.2, imageUrl: 'https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=400&h=300&fit=crop' },
  { id: 've34', name: 'Karaoke Kings', category: 'entertainment', address: 'Gràcia, 90', hasReservations: true, tags: ['karaoke'], availability: [], promoted: true, distanceKm: 2.4, imageUrl: 'https://images.unsplash.com/photo-1571907480495-4f2f24c9d3a9?w=400&h=300&fit=crop' },
  { id: 've35', name: 'Shôko Beach Club', category: 'entertainment', address: 'Port Olímpic, 36', hasReservations: true, tags: ['clubs'], availability: [], promoted: true, distanceKm: 3.7, imageUrl: 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=400&h=300&fit=crop' },
