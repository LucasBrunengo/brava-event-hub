...
export const mockVenues: Venue[] = [
  ...
  { id: 'v13', name: 'Barkadia', category: 'entertainment', address: 'Born, 12', hasReservations: false, tags: ['bars'], availability: [], promoted: true, distanceKm: 1.8, imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c76f0?w=400&h=300&fit=crop' },
  { id: 'v14', name: 'Sing It Karaoke', category: 'entertainment', address: 'Eixample, 77', hasReservations: true, tags: ['karaoke'], availability: [], promoted: false, distanceKm: 2.2, imageUrl: 'https://images.unsplash.com/photo-1571907480495-4f2f24c9d3a9?w=400&h=300&fit=crop' },
  ...
  { id: 'v17', name: 'K-Town Karaoke', category: 'entertainment', address: 'Les Corts, 20', hasReservations: true, tags: ['karaoke'], availability: [], promoted: false, distanceKm: 4.1, imageUrl: 'https://images.unsplash.com/photo-1571907480495-4f2f24c9d3a9?w=400&h=300&fit=crop' },
  ...
  { id: 've30a', name: 'Opium Barcelona', category: 'entertainment', address: 'Port Olímpic, 1', hasReservations: true, tags: ['clubs'], availability: [], promoted: true, distanceKm: 3.5, imageUrl: 'https://images.unsplash.com/photo-1520483601560-4b1128ff2f91?w=400&h=300&fit=crop' },
  { id: 've31a', name: 'The Box Cocktails', category: 'entertainment', address: 'El Born, 23', hasReservations: false, tags: ['bars'], availability: [], promoted: false, distanceKm: 1.5, imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c76f0?w=400&h=300&fit=crop' },
  ...
  { id: 've34a', name: 'Karaoke Kings', category: 'entertainment', address: 'Gràcia, 90', hasReservations: true, tags: ['karaoke'], availability: [], promoted: true, distanceKm: 2.4, imageUrl: 'https://images.unsplash.com/photo-1571907480495-4f2f24c9d3a9?w=400&h=300&fit=crop' },
